...
export { createLegacyProject, editorMediaIds, EDITOR_MEDIA_PLACEHOLDER, getEditorSnapshot, loadEditorProject, normalizeInvalidParagraphComponents, normalizeProjectData, replaceEditorMediaUrls, withEditorMediaPlaceholders } from "./projectData";
