            ...
            <div className="card shadow-sm h-100">
              ...
              <div className="card-body">
                ...
                <div className="mb-3">
                  ...
                  <div className="form-text">{t("web.settingsTitlePatternHint", { example: form.title_pattern.replaceAll("{page}", t("web.settingsTitlePatternExamplePage")).replaceAll("{site}", form.site_title || t("web.settingsTitlePatternExampleSite")) })}</div>
                </div>
                <div className="mb-3">
