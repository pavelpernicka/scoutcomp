...
BUILDER_LAYOUT_CSS = (
    ...
    ".sc2-event-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(18rem,1fr));gap:1.25rem}"
    ".sc2-event{display:flex;flex-direction:column;border-radius:.45rem;overflow:hidden;background:var(--sc2-card-bg,#fff);text-decoration:none;color:inherit;transition:box-shadow .2s ease,transform .2s ease}.sc2-event:hover,.sc2-event:focus-visible{box-shadow:0 .35rem 1.2rem rgba(0,0,0,.15);transform:translateY(-.15rem)}.sc2-event-cover{width:100%;height:10rem;object-fit:cover}.sc2-event-body{display:flex;flex-direction:column;gap:.35rem;padding:.9rem 1rem;flex:1}.sc2-event-body h3{margin:0;font-size:1.05rem}.sc2-event-body p{margin:0;font-size:.9rem;color:#556;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.sc2-event-body span{font-size:.82rem;font-weight:700;color:var(--sc-calendar-accent,#176b44)}"
