...
DEFAULT_THEME_SECTIONS.update({
    ...
    "scout-events": _sc2_project(_sc2("section", cls="sc2-section sc2-section-night", components=[_sc2("div", cls="sc2-container", components=[_sc2_heading("KALENDÁŘ", "Co nás čeká", "Schůzky, výpravy a velké oddílové akce."), _sc2("div", cls="sc2-event-grid", components=[{"type": "sc-repeat", "source": "core.events", "params": {"limit": 6}, "components": [_sc2("a", kind="link", cls="sc2-event", bindings={"href": {"scope": "context", "field": "url"}}, components=[{"type": "sc-condition", "condition": {"left": {"scope": "context", "field": "cover_url"}, "operator": "exists"}, "components": [_sc2("img", kind="image", cls="sc2-event-cover", attrs={"alt": "", "loading": "lazy"}, bindings={"src": {"scope": "context", "field": "cover_url"}})]}, _sc2("div", cls="sc2-event-body", components=[_sc2("h3", kind="heading", bindings={"text": {"scope": "context", "field": "title"}}), _sc2("p", bindings={"text": {"scope": "context", "field": "description"}}), _sc2("span", content="Zobrazit akci →")])])], "empty": [_sc2("p", content="Další akce právě připravujeme.")]}])])])),
