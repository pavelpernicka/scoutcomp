...
body:has(.ontario-page-top) .ontario-navbar .sc-menu-dropdown .sc-menu-link:hover,body:has(.ontario-page-top) .ontario-navbar .sc-menu-dropdown .sc-menu-link:focus-visible{color:var(--ontario-blue-dark);background:#eef4fb;outline:2px solid var(--ontario-blue);outline-offset:-2px}
