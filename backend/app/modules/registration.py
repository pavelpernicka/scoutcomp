...
def register_all_modules() -> None:
    ...
    registry.register(ModuleManifest("core", "Jádro", "Účty, družiny, kalendář, docházka a zprávy", "fa-house", "/",
        (("users.read", "Číst uživatele", "Zobrazit uživatele", False, ("team", "any")),
         ...
         ("posts.manage", "Správa příspěvků", "Vytvářet, upravovat a mazat příspěvky oddílu", False, ("any",)),
    ...
    registry.register(ModuleManifest("inventory", "Sklad", "Evidence a výdej oddílového vybavení", "fa-boxes-stacked", "/inventory",
        (("read", "Prohlížet sklad", "Číst evidenci skladu", False, ("any",)),
         ("manage", "Správa skladu", "Měnit skladovou evidenci", False, ("any",)),
         ("items.read", "Čtení položek", "Prohlížet skladové položky", False, ("any",)),
         ("items.manage", "Správa položek", "Vytvářet, upravovat a mazat položky", False, ("any",)),
         ("loans.manage", "Výpůjčky", "Půjčovat a přijímat vybavení", False, ("any",)),
         ("locations.manage", "Správa lokací", "Spravovat lokace", False, ("any",)),
    ...
    registry.register(ModuleManifest("web", "Webové stránky", "Vizuální CMS a veřejný web", "fa-globe", "/admin/web/pages",
        (("manage", "Správa webu", "Úplná správa CMS", False, ("any",)),
         ...
         ("posts.manage", "Správa příspěvků", "Vytvářet, upravovat a mazat příspěvky", False, ("any",)),
         ("media.manage", "Správa médií", "Nahrávat a spravovat média", False, ("any",)),
         ("menus.manage", "Správa menu", "Vytvářet, upravovat a publikovat menu", False, ("any",)),
